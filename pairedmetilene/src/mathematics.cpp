...
double
mannwhitneyPvalue(
  Uint u, Uint m, Uint n, double ***CDF, Uint maxm, Uint maxn,
  int nonZeroPairs
  ) {
...
Uint
mannwhitney(double *a, Uint m, double *b, Uint n, int *nonZeroPairs)
{
    ...
    // printf("%d\n",n);
    Uint  *sorted;
    double *ranks, sumNegative = 0.0, sumPositive = 0.0, ans;
    double *c;
