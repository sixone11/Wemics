...
double mannwhitneyPvalue(Uint u, Uint m, Uint n, double ***CDF, Uint maxm, Uint maxn, int  nonZeroPairs);
Uint mannwhitney(double *a, Uint m, double *b, Uint n, int * nonZeroPairs);
